...
public interface PostDao {
	...
	List<Post> getPost(@Param("startPos") int startPos,@Param("pageSize") int pageSize);
	...
	List<Post> getPostByParentId(@Param("startPos") int startPos,@Param("pageSize") int pageSize,@Param("parentId") int parentId);
